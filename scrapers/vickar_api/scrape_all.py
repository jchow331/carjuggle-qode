...
logger_name = 'vickar_bots_canada'
email_subject = 'Vickar Bot Alert'
    ...
    for vehicle in vehicles:
        try:
            ...
            try:
                ...
                info[3] = 'https://www.vickar.com/vehicles' + url_last
            except KeyError:
                pass
            # make
            try:
...
def main():
    ...
    local_file_path = os.path.join(scraper_dir, "results/vickar_result.csv")
    aws_bucket_file_path = "MasterCode1/scraping/vickar/vickar_result.csv"
    aws_bucket_folder_path = "MasterCode1/scraping/vickar"
    if not os.path.exists(local_file_path):
        aws_handler.download_from_aws(aws_bucket_file_path, local_file_path)

    scrape_df = pd.read_csv(local_file_path)
    url = "https://vms.prod.convertus.rocks/api/filtering/?cp=538&ln=en&pg=1&pc=50&dc=false&qs=&im=true&svs=&sc=all&v1=Passenger Vehicles&st=price%2Casc&ai=&oem=&mk=&md=&tr=&bs=&tm=&dt=&cy=&ec=&mc=&ic=&pa=&ft=&eg=&v2=&v3=&fp=&fc=&fn=&tg=&pnpi=msrp&pnpm=none&pnpf=inte&pupi=none&pupm=none&pupf=inte&nnpi=none&nnpm=none&nnpf=none&nupi=none&nupm=none&nupf=none&po="
