...
logger_name = 'carloft_cleaner_bots_canada'
email_subject = 'Carloft Cleaner Bot Alert'
...
def clean_makes(df,trims_kbb):
    ...
    df['make']=df['url'].str.split('/').str[4].str.title()
...
def main():
    ...
    #PREVIOUS_RESULT_PATH = 'MasterCode1/cleaning/carloft/carloft_result_previous.csv'
    RESULT_PATH = 'MasterCode1/scraping/carloft/carloft_result.csv'
    DECODED_PATH = "MasterCode1/cleaning/carloft/decoded.csv"
    ...
    PROGRESS_PATH = 'MasterCode1/cleaning/carloft/cleaned_carloft_progress.csv'
    EXPORT_PATH_TIMELESS = "MasterCode1/cleaning/carloft/cleaned_carloft_timeless.csv"
    EXPORT_PATH_TIME = 'MasterCode1/cleaning/carloft/cleaned_carloft_time.csv'
