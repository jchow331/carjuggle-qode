...
logger_name = 'carpages_cleaner_bots_canada'
email_subject = 'Carpages Cleaner Bot Alert'
...
def clean_numowners_previousaccident(df):
    ...
    logger.info(f"Cleaning owners and previosu accidents... ")
    ...
    logger.info(f"Cleaning owners and previosu accidents... Done")
    logger.info(f"size is  {df.shape}")
...
def main():
    ...
    RESULT_PATH = 'MasterCode1/scraping/carpages/carpages_result.csv'
    ...
    PROGRESS_PATH = 'MasterCode1/cleaning/carpages/cleaned_carpages_progress.csv'
    EXPORT_PATH_TIMELESS = "MasterCode1/cleaning/carpages/cleaned_carpages_timeless.csv"
    EXPORT_PATH_TIME = 'MasterCode1/cleaning/carpages/cleaned_carpages_time.csv'
