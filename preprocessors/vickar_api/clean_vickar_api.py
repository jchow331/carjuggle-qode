...
def import_files( RESULT_PATH, KBB_PATH, LOCATIONS_PATH,GEOLOC_PATH , EXTRA_GEO_PATH, EXPORT_PATH_TIMELESS):
    ...
    #print(df)
    df["province"].fillna("MB", inplace = True)
    df["City"].fillna("Winnipeg", inplace = True)
...
def main():
    ...
    RESULT_PATH = 'MasterCode1/scraping/vickar/vickar_result.csv'
    DECODED_PATH = "MasterCode1/cleaning/vickar/decoded.csv"
    ...
    # PROGRESS_PATH = 'MasterCode1/cleaning/vickar/cleaned_carpages_progress.csv'
    EXPORT_PATH_TIMELESS = "MasterCode1/cleaning/vickar/cleaned_vickar_timeless.csv"
    EXPORT_PATH_TIME = 'MasterCode1/cleaning/vickar/cleaned_vickar_time.csv'
