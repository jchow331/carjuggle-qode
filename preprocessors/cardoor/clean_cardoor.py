...
logger_name = 'cardoor_cleaner_bots_canada'
email_subject = 'Cardoor Cleaner Bot Alert'
...
def main():
    ...
    #PREVIOUS_RESULT_PATH = 'MasterCode1/cleaning/cardoor/cardoor_result_previous.csv'
    RESULT_PATH = 'MasterCode1/scraping/cardoor/cardoor_result.csv'
    DECODED_PATH = "MasterCode1/cleaning/cardoor/decoded.csv"
    ...
    PROGRESS_PATH = 'MasterCode1/cleaning/cardoor/cleaned_cardoor_progress.csv'
    EXPORT_PATH_TIMELESS = "MasterCode1/cleaning/cardoor/cleaned_cardoor_timeless.csv"
    EXPORT_PATH_TIME = 'MasterCode1/cleaning/cardoor/cleaned_cardoor_time.csv'
