...
logger_name = 'murrayautogroup_cleaner_bots_canada'
email_subject = 'Murrayautogroup Cleaner Bot Alert'
...
def import_files( RESULT_PATH, KBB_PATH, LOCATIONS_PATH,GEOLOC_PATH , EXTRA_GEO_PATH, EXPORT_PATH_TIMELESS):
    ...
    df['province'] = df['url'].str.split('/').str[-3].str.upper()
    df ['City'] =  df['url'].str.split('/').str[-4].str.title()     
    #print(df)
...
def main():
    ...
    RESULT_PATH = 'MasterCode1/scraping/murrayautogroup/murrayautogroup_result.csv'
    DECODED_PATH = "MasterCode1/cleaning/murrayautogroup/decoded.csv"
    ...
    # PROGRESS_PATH = 'MasterCode1/cleaning/murrayautogroup/cleaned_murrayautogroup_progress.csv'
    EXPORT_PATH_TIMELESS = "MasterCode1/cleaning/murrayautogroup/cleaned_murrayautogroup_timeless.csv"
    EXPORT_PATH_TIME = 'MasterCode1/cleaning/murrayautogroup/cleaned_murrayautogroup_time.csv'
