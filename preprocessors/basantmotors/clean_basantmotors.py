...
logger_name = 'basantmotors_cleaner_bots_canada'
email_subject = 'basantmotors Cleaner Bot Alert'
...
def main():
    ...
    #PREVIOUS_RESULT_PATH = 'MasterCode1/cleaning/basantmotors/basantmotors_result_previous.csv'
    RESULT_PATH = 'MasterCode1/scraping/basantmotors/basantmotors_result.csv'
    DECODED_PATH = "MasterCode1/cleaning/basantmotors/decoded.csv"
    ...
    PROGRESS_PATH = 'MasterCode1/cleaning/basantmotors/cleaned_basantmotors_progress.csv'
    EXPORT_PATH_TIMELESS = "MasterCode1/cleaning/basantmotors/cleaned_basantmotors_timeless.csv"
    EXPORT_PATH_TIME = 'MasterCode1/cleaning/basantmotors/cleaned_basantmotors_time.csv'
