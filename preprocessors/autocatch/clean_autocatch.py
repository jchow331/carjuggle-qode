...
logger_name = 'autocatch_cleaner_bots_canada'
email_subject = 'Autocatch Cleaner Bot Alert'
...
def initial_formatting(df, dfcleaned):
    ...
    df.drop(df[df['kilometers'].astype(str).str.contains('href', na=False)].index,inplace=True)
    df.reset_index(drop=True, inplace=True)
...
# # =============================================================================
    ...
    df['province'].replace(to_replace='Northwest Territory', value='Northwest Territories', regex=True, inplace=True)
...
def clean_drivetrain(df):
    ...
    #print("all empty values... Attempts to get the drivetrain back")
...
def main():
    ...
    RESULT_PATH = 'MasterCode1/scraping/autocatch/autocatch_result.csv'
    #DECODED_PATH = "MasterCode1/cleaning/autocatch/decoded.csv"
    ...
    PROGRESS_PATH = 'MasterCode1/cleaning/autocatch/cleaned_autocatch_progress.csv'
    EXPORT_PATH_TIMELESS = "MasterCode1/cleaning/autocatch/cleaned_autocatch_timeless.csv"
    EXPORT_PATH_TIME = 'MasterCode1/cleaning/autocatch/cleaned_autocatch_time.csv'
